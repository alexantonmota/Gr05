...
public class Gestion extends JDialog {
	...
	public Gestion() {
		...
		getContentPane().add(contentPanel, BorderLayout.WEST);
		{
			...
			lblCl.setIcon(new ImageIcon("./Imagenes/gfdj.png"));
		...
		}
		{
			...
			lblAd.setIcon(new ImageIcon("./Imagenes/oli.png"));		
		...
		lblPe.setIcon(new ImageIcon("./Imagenes/hgj.png"));
		...
		lblEn.setIcon(new ImageIcon("./Imagenes/cghck.png"));
