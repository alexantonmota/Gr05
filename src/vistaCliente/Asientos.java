...
/**
 * Clase que en sí iba a ser para seleccionar asientos pero se ha quedado en previsualizar la sala, los métodos comentados serían los de asignar lugar de manera aleatoria y escoger lugar
 * @author alex
 */
